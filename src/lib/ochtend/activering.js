...
export const REK_OEFENINGEN = [
  ...
  { id: 'r3', naam: 'Nek langzaam draaien', uitleg: 'Links houd 3s, midden, rechts houd 3s — 5× per kant. Niet forceren.', duur: '35s (incl. 5s om in positie te komen)' },
...
// Kindhouding en de nek-rek krijgen een eigen timer (i.p.v. alleen een
...
// komen na het starten van de timer.
export const KINDHOUDING_ID = 'r6';
export const KINDHOUDING_TIMER_SECONDEN = 35;
export const NEKSTREK_ID = 'r3';
export const NEKSTREK_TIMER_SECONDEN = 35;
